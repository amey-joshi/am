...
This equation also has an unable point at the origin. The phase portrait has
arrows diverging from the origin. The trajectories follow these directions.
\begin{figure}[h]
...
is shown as a dashed line ending with a red square. The trajectories of the
